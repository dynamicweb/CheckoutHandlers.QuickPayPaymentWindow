...
public class QuickPayUpdateProvider : UpdateProvider
{
    ...
    public override IEnumerable<Update> GetUpdates()
    {
        return new List<Update>()
        {
            ...
            new FileUpdate("c30f6547-1722-4cc1-a581-03ddcdf97540", this, "/Files/Templates/eCom7/CheckoutHandler/QuickPayPaymentWindow/Post/Post.html", () => GetResourceStream("Post.html")),
        };
    }
